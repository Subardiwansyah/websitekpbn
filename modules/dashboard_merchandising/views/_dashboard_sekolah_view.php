				...
				<script>
					$(document).ready(function(){
						reload_grafik_sek_spanduk(); // Spanduk Share
						reload_grafik_sek_poster(); // Poster Share
					});

					// ==============================================================================
					// BEGIN SPANDUK SHARE
					// ==============================================================================
					var reload_grafik_sek_spanduk = function(){
						...
						Highcharts.chart('grafik_sek_spanduk', {
							chart: {
								type: 'column'
							},
							colors: colors,
											...
											if($kategori == 'Branch')
											{
												if($pilihan == '-')
												{
													$query = $this->db->query('
															...
															WHERE (m.tahun = "'.$tahun.'"
																	AND m.bulan = "'.$i.'"
																	AND UPPER(m.id_jenis_lokasi) = "SEK"
					...
					// BEGIN POSTER SHARE
					// ==============================================================================
					var reload_grafik_sek_poster = function(){
						var colors = Highcharts.getOptions().colors.slice(0),
						dark = -0.5;
						colors[0] = '#DD0000';
						colors[1] = '#fede00';
						...
						Highcharts.chart('grafik_sek_poster', {
							chart: {
								type: 'column'
							},
							colors: colors,
