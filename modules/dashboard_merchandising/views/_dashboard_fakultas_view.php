				...
				<script>
					$(document).ready(function(){
						reload_grafik_fak_spanduk(); // Spanduk Share
						reload_grafik_fak_poster(); // Poster Share
					});

					// ==============================================================================
					// BEGIN SPANDUK SHARE
					// ==============================================================================
					var reload_grafik_fak_spanduk = function(){
						...
						Highcharts.chart('grafik_fak_spanduk', {
							chart: {
								type: 'column'
							},
							colors: colors,
											...
											if($kategori == 'Branch')
											{
												if($pilihan == '-')
												{
													$query = $this->db->query('
															...
															WHERE (m.tahun = "'.$tahun.'"
																	AND m.bulan = "'.$i.'"
																	AND UPPER(m.id_jenis_lokasi) = "FAK"
					...
					// BEGIN POSTER SHARE
					// ==============================================================================
					var reload_grafik_fak_poster = function(){
						var colors = Highcharts.getOptions().colors.slice(0),
						dark = -0.5;
						colors[0] = '#DD0000';
						colors[1] = '#fede00';
						...
						Highcharts.chart('grafik_fak_poster', {
							chart: {
								type: 'column'
							},
							colors: colors,
