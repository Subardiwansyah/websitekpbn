													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_universitas">
																...
																<input type="text" style="width:100%" class="select2" id="nm_universitas" data-bind="value: nm_universitas" />
															</div>
															<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_fakultas">
																...
																<input type="text" class="form-control form-control-sm" id="nm_fakultas" data-bind="value: nm_fakultas">
															</div>
														</div>
														...
														<div class="form-row">
															...
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																...
																<input type="text" class="form-control form-control-sm" id="jml_dosen" data-bind="value: jml_dosen">
															</div>
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																<label class="form-label" for="jml_mhs">Jumlah Mahasiswa </label>
																<input type="text" class="form-control form-control-sm" id="jml_mhs" data-bind="value: jml_mhs">
															</div>
														</div>
													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: nm_owner">
																...
																<input type="text" class="form-control form-control-sm" id="nm_owner" data-bind="value: nm_owner">
															</div>
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3" data-bind="validationElement: no_hp_owner">
																...
																<input type="text" class="form-control form-control-sm" id="no_hp_owner" data-bind="value: no_hp_owner">
															</div>
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																<label class="form-label" for="tgl_lahir_owner">Tgl Lahir </label>
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_dekan']) ? format_date($data['tgl_lahir_dekan']) : '' ?>">
																	<div class="input-group-append">
																		<span class="input-group-text fs-xl">
																			<i class="fal fa-calendar-alt"></i>
																		</span>
														...
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																...
																<input type="text" class="form-control form-control-sm" id="hobi_owner" data-bind="value: hobi_owner">
															</div>
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																<label class="form-label" for="akun_fb_owner">Akun Facebook </label>
																<input type="text" class="form-control form-control-sm" id="akun_fb_owner" data-bind="value: akun_fb_owner">
															</div>
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																<label class="form-label" for="akun_ig_owner">Akun Instagram </label>
																<input type="text" class="form-control form-control-sm" id="akun_ig_owner" data-bind="value: akun_ig_owner">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: nm_pic">
																...
																<input type="text" class="form-control form-control-sm" id="nm_pic" data-bind="value: nm_pic">
															</div>
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3" data-bind="validationElement: no_hp_pic">
																...
																<input type="text" class="form-control form-control-sm" id="no_hp_pic" data-bind="value: no_hp_pic">
															</div>
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																<label class="form-label" for="tgl_lahir_pic">Tgl Lahir </label>
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_pic" data-bind="value: tgl_lahir_pic" value="<?php echo isset($data['tgl_lahir_pic']) ? format_date($data['tgl_lahir_pic']) : '' ?>">
																	<div class="input-group-append">
																		<span class="input-group-text fs-xl">
																			<i class="fal fa-calendar-alt"></i>
																		</span>
														...
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																...
																<input type="text" class="form-control form-control-sm" id="hobi_pic" data-bind="value: hobi_pic">
															</div>
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																<label class="form-label" for="akun_fb_pic">Akun Facebook </label>
																<input type="text" class="form-control form-control-sm" id="akun_fb_pic" data-bind="value: akun_fb_pic">
															</div>
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																<label class="form-label" for="akun_ig_pic">Akun Instagram </label>
																<input type="text" class="form-control form-control-sm" id="akun_ig_pic" data-bind="value: akun_ig_pic">
															</div>
														</div>
													</div>
												</div>
