												...
												<div class="tab-content my-3">
													<div class="tab-pane fade show active" id="tab_profile" role="tabpanel">
														...
														<div class="card mb-3">
															<div class="card-body">
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_universitas">
																		<label class="form-label" for="nm_universitas">Universitas <span class="text-danger">*</span> </label>
																		<input type="text" style="width:100%" class="select2" id="nm_universitas" data-bind="disable: true, value: nm_universitas" />
																	</div>
																	<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_fakultas">
																		<label class="form-label" for="nm_fakultas">Nama Fakultas <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="nm_fakultas" data-bind="disable: true, value: nm_fakultas">
																	</div>
																</div>
																...
																<div class="form-row">
																		...
																		<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																			<label class="form-label" for="jml_dosen">Jumlah Dosen </label>
																			<input type="text" class="form-control form-control-sm" id="jml_dosen" data-bind="disable: true, value: jml_dosen">
																		</div>
																		<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																			<label class="form-label" for="jml_mhs">Jumlah Mahasiswa </label>
																			<input type="text" class="form-control form-control-sm" id="jml_mhs" data-bind="disable: true, value: jml_mhs">
																		</div>
																	</div>
															...
															<div class="card-body">
																<div class="form-row">
																	...
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																		...
																		<div class="input-group input-group-sm">
																			<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="disable: true, value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_dekan']) ? format_date($data['tgl_lahir_dekan']) : '' ?>">
																			<div class="input-group-append">
																				<span class="input-group-text fs-xl">
																					<i class="fal fa-calendar-alt"></i>
																				</span>
					...
					<script>
						...
						$(document).ready(function()
						{
							...
							$('#nm_universitas').select2({
								minimumInputLength: 0,
								ajax: {
									url: GLOBAL_MAIN_VARS["BASE_URL"] + 'pilih/get_universitas',
									type: 'POST',
									dataType: 'json',
									quietMillis: 200,
									data: function(term){
							...
							$('#nm_universitas').on('change', function(e){
								var idx = e.target.id;
								var pos = idx.indexOf('nm_universitas');

								if (pos > -1)
								{
									var pre = idx.substring(0, pos);
									App.id_universitas(e.added ? e.added.id : '');
									App.nm_universitas(e.added ? e.added.nama : '');
						...
						var ModelForm = function(){
							...
							self.id = ko.observable("<?php echo isset($data['id_fakultas']) ? $data['id_fakultas'] : 0 ?>");
							self.id_universitas = ko.observable("<?php echo isset($data['id_universitas']) ? $data['id_universitas'] : '' ?>")
								.extend({
									required: {params: true, message: 'Universitas tidak boleh kosong'}
							});
							self.nm_universitas = ko.observable("<?php echo isset($data['nama_universitas']) ? $data['nama_universitas'] : '' ?>");
							self.nm_fakultas = ko.observable("<?php echo isset($data['nama_fakultas']) ? $data['nama_fakultas'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Fakultas tidak boleh kosong'}
							});
							...
							self.alamat = ko.observable("<?php echo isset($data['alamat_fakultas']) ? $data['alamat_fakultas'] : '' ?>")
								.extend({
							...
							self.jml_dosen = ko.observable("<?php echo isset($data['jumlah_dosen']) ? $data['jumlah_dosen'] : 0 ?>");
							self.jml_mhs = ko.observable("<?php echo isset($data['jumlah_mahasiswa']) ? $data['jumlah_mahasiswa'] : 0 ?>");
							...
							self.nm_owner = ko.observable("<?php echo isset($data['nama_dekan']) ? $data['nama_dekan'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Dekan tidak boleh kosong'}
							});
							self.no_hp_owner = ko.observable("<?php echo isset($data['no_hp_dekan']) ? $data['no_hp_dekan'] : '' ?>")
								.extend({
									required: {params: true, message: 'No Hp Dekan tidak boleh kosong'}
							});
							self.tgl_lahir_owner = ko.observable("<?php echo isset($data['tgl_lahir_dekan']) ? format_date($data['tgl_lahir_dekan']) : '' ?>");
							self.hobi_owner = ko.observable("<?php echo isset($data['hobi_dekan']) ? $data['hobi_dekan'] : '' ?>");
							self.akun_fb_owner = ko.observable("<?php echo isset($data['akun_fb_dekan']) ? $data['akun_fb_dekan'] : '' ?>");
							self.akun_ig_owner = ko.observable("<?php echo isset($data['akun_ig_dekan']) ? $data['akun_ig_dekan'] : '' ?>");
