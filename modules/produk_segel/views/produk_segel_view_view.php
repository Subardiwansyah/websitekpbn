													...
													<div class="card-body">
														...
														<div class="form-row">
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3" data-bind="validationElement: harga_bandrol">
																...
																<input type="text" class="form-control form-control-sm currency currencyonly text-right" id="harga_bandrol" autocomplete="off" data-bind="disable: true, value: harga_bandrol">
															</div>
