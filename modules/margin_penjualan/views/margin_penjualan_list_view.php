								...
								<div id="panel-0" class="panel">
									...
									<div class="panel-container show">
										<div class="panel-content">
											...
											<div id="konten_margin"></div>
											<div id="konten_grafik"></div>
					...
					<script>
						...
						App.tampil = function(){
							...
							$('#konten_margin').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/get_data_margin/' +
								id_tap + '/' +
								tahun + '/' +
								bulan + '/' +
								minggu + '/'
							...
							// $('#konten_grafik').load(
								// GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/get_data_grafik/' +
								// id_tap + '/' +
								// tahun + '/' +
								// bulan + '/' +
								// minggu + '/'
