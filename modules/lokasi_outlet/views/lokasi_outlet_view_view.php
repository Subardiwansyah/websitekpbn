												...
												<div class="tab-content my-3">
													<div class="tab-pane fade show active" id="tab_profile" role="tabpanel">
														...
														<div class="card mb-3">
															<div class="card-body">
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_digipos">
																		<label class="form-label" for="id_digipos">ID Digipos <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="id_digipos" data-bind="disable: true, value: id_digipos">
																	</div>
																	<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_outlet">
																		<label class="form-label" for="nm_outlet">Nama Outlet <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="nm_outlet" data-bind="disable: true, value: nm_outlet">
																	</div>
																</div>
																...
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_jns_outlet">
																		<label class="form-label" for="nm_jns_outlet">Jenis Outlet <span class="text-danger">*</span> </label>
																		<input type="text" style="width:100%" class="select2" id="nm_jns_outlet" data-bind="disable: true, value: nm_jns_outlet" />
																	</div>
															...
															<div class="card-body">
																<div class="form-row">
																	...
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																		...
																		<div class="input-group input-group-sm">
																			<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="disable: true, value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_owner']) ? format_date($data['tgl_lahir_owner']) : '' ?>">
																			<div class="input-group-append">
																				<span class="input-group-text fs-xl">
																					<i class="fal fa-calendar-alt"></i>
																				</span>
					...
					<script>
						...
						$(document).ready(function()
						{
							...
							$('#nm_jns_outlet').select2({
								minimumInputLength: 0,
								ajax: {
									url: GLOBAL_MAIN_VARS["BASE_URL"] + 'pilih/get_jenis_outlet',
									type: 'POST',
									dataType: 'json',
									quietMillis: 200,
									data: function(term){
							...
							$('#nm_jns_outlet').on('change', function(e){
								var idx = e.target.id;
								var pos = idx.indexOf('nm_jns_outlet');

								if (pos > -1)
								{
									var pre = idx.substring(0, pos);
									App.id_jns_outlet(e.added ? e.added.id : '');
									App.nm_jns_outlet(e.added ? e.added.nama : '');
						...
						var ModelForm = function(){
							...
							self.id = ko.observable("<?php echo isset($data['id_outlet']) ? $data['id_outlet'] : 0 ?>");
							self.id_digipos = ko.observable("<?php echo isset($data['id_digipos']) ? $data['id_digipos'] : '' ?>")
								.extend({
									required: {params: true, message: 'ID Digipos tidak boleh kosong'}
							});
							self.nm_outlet = ko.observable("<?php echo isset($data['nama_outlet']) ? $data['nama_outlet'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Outlet tidak boleh kosong'}
							});
							...
							self.alamat = ko.observable("<?php echo isset($data['alamat_outlet']) ? $data['alamat_outlet'] : '' ?>")
								.extend({
							...
							self.id_jns_outlet = ko.observable("<?php echo isset($data['id_jenis_outlet']) ? $data['id_jenis_outlet'] : '' ?>")
								.extend({
									required: {params: true, message: 'Jenis Outlet tidak boleh kosong'}
							});
							self.nm_jns_outlet = ko.observable("<?php echo isset($data['nama_jenis_outlet']) ? $data['nama_jenis_outlet'] : '' ?>");
							...
							self.nm_owner = ko.observable("<?php echo isset($data['nama_owner']) ? $data['nama_owner'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Owner tidak boleh kosong'}
							});
							self.no_hp_owner = ko.observable("<?php echo isset($data['no_hp_owner']) ? $data['no_hp_owner'] : '' ?>")
								.extend({
									required: {params: true, message: 'No Hp Owner tidak boleh kosong'}
							});
							self.tgl_lahir_owner = ko.observable("<?php echo isset($data['tgl_lahir_owner']) ? format_date($data['tgl_lahir_owner']) : '' ?>");
							self.hobi_owner = ko.observable("<?php echo isset($data['hobi_owner']) ? $data['hobi_owner'] : '' ?>");
							self.akun_fb_owner = ko.observable("<?php echo isset($data['akun_fb_owner']) ? $data['akun_fb_owner'] : '' ?>");
							self.akun_ig_owner = ko.observable("<?php echo isset($data['akun_ig_owner']) ? $data['akun_ig_owner'] : '' ?>");
