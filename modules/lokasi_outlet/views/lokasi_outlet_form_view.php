													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_digipos">
																...
																<input type="text" class="form-control form-control-sm" id="id_digipos" data-bind="value: id_digipos">
															</div>
															<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_outlet">
																...
																<input type="text" class="form-control form-control-sm" id="nm_outlet" data-bind="value: nm_outlet">
															</div>
														</div>
														...
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_jns_outlet">
																...
																<input type="text" style="width:100%" class="select2" id="nm_jns_outlet" data-bind="value: nm_jns_outlet" />
															</div>
													...
													<div class="card-body">
														<div class="form-row">
															...
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																...
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_owner']) ? format_date($data['tgl_lahir_owner']) : '' ?>">
																	<div class="input-group-append">
																		<span class="input-group-text fs-xl">
																			<i class="fal fa-calendar-alt"></i>
																		</span>
					...
					<script>
						...
						var ModelForm = function(){
							...
							self.status = ko.observable("<?php echo isset($data['status']) ? $data['status'] : '' ?>");
