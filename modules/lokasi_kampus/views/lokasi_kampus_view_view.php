												...
												<ul class="nav nav-tabs nav-tabs-clean" role="tablist">
													...
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="#tab_merchandising" role="tab">
															<i class="fal fa-apple-cubes mr-1 text-info"></i>
															Merchandising
														</a>
													</li>
													<li class="nav-item">
															...
															<div class="card-body">
																<div class="form-row">
																	...
																	<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_universitas">
																		...
																		<input type="text" class="form-control form-control-sm" id="nm_universitas" data-bind="disable: true, value: nm_universitas">
																	</div>
																</div>
															...
															<div class="card-body">
																<div class="form-row">
																	...
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																		...
																		<div class="input-group input-group-sm">
																			<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="disable: true, value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_rektor']) ? format_date($data['tgl_lahir_rektor']) : '' ?>">
																			<div class="input-group-append">
																				<span class="input-group-text fs-xl">
																					<i class="fal fa-calendar-alt"></i>
																				</span>
