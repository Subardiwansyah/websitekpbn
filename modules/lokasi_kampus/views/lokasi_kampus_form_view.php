												...
												<div class="card mb-3">
													<div class="card-body">
														<div class="form-row">
															...
															<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_universitas">
																<label class="form-label" for="nm_universitas">Nama Universitas <span class="text-danger">*</span> </label>
																<input type="text" class="form-control form-control-sm" id="nm_universitas" data-bind="value: nm_universitas">
															</div>
														</div>
													...
													<div class="card-body">
														<div class="form-row">
															...
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																...
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_rektor']) ? format_date($data['tgl_lahir_rektor']) : '' ?>">
																	<div class="input-group-append">
																		<span class="input-group-text fs-xl">
																			<i class="fal fa-calendar-alt"></i>
																		</span>
					...
					<script>
						...
						var ModelForm = function(){
							...
							self.id = ko.observable("<?php echo isset($data['id_universitas']) ? $data['id_universitas'] : 0 ?>");
							...
							self.nm_universitas = ko.observable("<?php echo isset($data['nama_universitas']) ? $data['nama_universitas'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Universitas tidak boleh kosong'}
							});
							...
							self.alamat = ko.observable("<?php echo isset($data['alamat_universitas']) ? $data['alamat_universitas'] : '' ?>")
								.extend({
							...
							self.nm_owner = ko.observable("<?php echo isset($data['nama_rektor']) ? $data['nama_rektor'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Rektor tidak boleh kosong'}
							});
							self.no_hp_owner = ko.observable("<?php echo isset($data['no_hp_rektor']) ? $data['no_hp_rektor'] : '' ?>")
								.extend({
									required: {params: true, message: 'No Hp Rektor tidak boleh kosong'}
							});
							self.tgl_lahir_owner = ko.observable("<?php echo isset($data['tgl_lahir_rektor']) ? format_date($data['tgl_lahir_rektor']) : '' ?>");
							self.hobi_owner = ko.observable("<?php echo isset($data['hobi_rektor']) ? $data['hobi_rektor'] : '' ?>");
							self.akun_fb_owner = ko.observable("<?php echo isset($data['akun_fb_rektor']) ? $data['akun_fb_rektor'] : '' ?>");
							self.akun_ig_owner = ko.observable("<?php echo isset($data['akun_ig_rektor']) ? $data['akun_ig_rektor'] : '' ?>");
