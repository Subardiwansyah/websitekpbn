...
class Kecamatan_model extends CI_model {
	...
	function insert_data_kecamatan()
  {
							...
							, (
										...
										FROM
												...
												INNER JOIN ec_sekolah xl
														ON (xpj.id_lokasi = xl.id_sekolah)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xpj.tgl_transaksi, "%Y") =  "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												...
												INNER JOIN ed_kampus xl
														ON (xpj.id_lokasi = xl.id_universitas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xpj.tgl_transaksi, "%Y") =  "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												...
												INNER JOIN ee_fakultas xl
														ON (xpj.id_lokasi = xl.id_fakultas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xpj.tgl_transaksi, "%Y") =  "'.$tahun_sekarang.'"
		...
		if (!empty($rs))
		{
			...
			{
				$this->db->select('1');
				$this->db->from('an_dashboard_distribusi_kecamatan');
				...
				if ($rsx)
				{
					...
					$this->db->where('bulan', (int) $bulan_sekarang);
					$this->db->where('id_kecamatan', $rs[$x]['id_kecamatan']);
					$this->db->update('an_dashboard_distribusi_kecamatan', $data_x);
					$this->check_trans_status('update an_dashboard_distribusi_kecamatan failed');
				}
				else
				{
					$data_x = array(
					...
					$this->db->insert('an_dashboard_distribusi_kecamatan', $data_x);
					$this->check_trans_status('insert an_dashboard_distribusi_kecamatan failed');
				}
			}
		}
	}
