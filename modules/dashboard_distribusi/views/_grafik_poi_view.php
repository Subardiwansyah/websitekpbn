				<div class="row">
					...
					<div class="col-md-3">
						<div class="card">
							<div class="card-body">
								<div id="grafik_poi_4" style="height:200px;"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<script>
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_segel_total), 0) AS jumlah
														FROM
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_sa_total), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_vf_total), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_segel_prepaid), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_segel_voucher), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_sa_ld), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_sa_md), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_sa_hd), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
					...
					var reload_grafik_poi_4 = function(){
						Highcharts.chart('grafik_poi_4', {
							chart: {
								type: 'column'
							},
							title: {
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_vf_ld), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_vf_md), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
									...
									<?php
										for($i=1; $i<=12; $i++)
										{
											...
											if($kategori == 'Branch')
											{
												...
												$query = $this->db->query('
														SELECT
																COALESCE(SUM(d.poi_vf_hd), 0) AS jumlah
														FROM
																aj_dashboard_distribusi_branch d
														WHERE d.tahun = "'.$tahun.'"
																AND d.bulan = "'.$i.'"
