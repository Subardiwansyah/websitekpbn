															...
															<div class="col-md-6">
																...
																<div class="form-row">
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: id_jns_produk">
																		...
																		<input type="text" style="width:100%" class="select2" id="nm_jns_produk" data-bind="disable: true, value: nm_jns_produk" />
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: id_jns_inject">
																		...
																		<input type="text" style="width:100%" class="select2" id="nm_jns_inject" data-bind="disable: true, value: nm_jns_inject" />
																	</div>
																</div>
																...
																<div class="form-row">
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: id_kabupaten">
																		...
																		<input type="text" style="width:100%" class="select2" id="nm_kabupaten" data-bind="disable: true, value: nm_kabupaten" />
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: id_zona">
																		...
																		<input type="text" style="width:100%" class="select2" id="nm_zona" data-bind="disable: true, value: nm_zona" />
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: total_kuota">
																		...
																		<input type="text" class="form-control form-control-sm integer integeronly text-right" id="total_kuota" autocomplete="off" data-bind="disable: true, value: total_kuota">
																	</div>
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: harga_paket">
																		...
																		<input type="text" class="form-control form-control-sm currency currencyonly text-right" id="harga_paket" autocomplete="off" data-bind="disable: true, value: harga_paket">
																	</div>
																</div>

																<div class="form-group">
																	<label class="form-label" for="keterangan">Keterangan</label>
																	<textarea disabled class="form-control" id="keterangan" rows="3"><?php echo isset($data['keterangan']) ? $data['keterangan'] : '' ?></textarea>
																</div>
															</div>
														</div>
