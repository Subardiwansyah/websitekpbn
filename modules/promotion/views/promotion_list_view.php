					...
					<script>
						...
						$(document).ready(function()
						{
							...
							$('#pilihan').select2({
								...
								ajax: {
									url: GLOBAL_MAIN_VARS["BASE_URL"] + 'pilih/get_pilihan_by_promotion',
									type: 'POST',
									dataType: 'json',
									quietMillis: 200,
									data: function(term){
							...
							$('#pilihan').on('change', function(e){
								...
								if (pos > -1)
								{
									...
									App.pilihan(e.added ? e.added.id : 0);
						...
						var ModelForm = function(){
							...
							self.jenis_lokasi = ko.observable("out");
							self.jenis_share = ko.observable("");
						...
						App.tampil = function(){
							...
							$('#konten_promotion').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/promotion_form/' +								
								kategori + '/' +
								pilihan + '/' +
								tahun + '/' +
								bulan + '/' +
