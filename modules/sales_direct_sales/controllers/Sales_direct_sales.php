...
class Sales_direct_sales extends Base_Controller {

	function __construct()
	{
		parent::__construct($securePage=true);

		$this->modul_name = 'sales_direct_sales';
		$this->daftar_display = 'List Direct Sales';
		$this->form_display = 'Form Direct Sales';
		$this->modul_display = 'Direct Sales';
		$this->view_list = 'sales_direct_sales_list_view';
		$this->view_form = 'sales_direct_sales_form_view';
		$this->view_view = 'sales_direct_sales_view_view';
		$this->load->model('Sales_direct_sales_model', 'data_model');
	}
