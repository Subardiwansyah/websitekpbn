													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-12 col-sm-12 col-xs-12 mb-3" data-bind="validationElement: nm_sales">
																...
																<input type="text" class="form-control form-control-sm" id="nm_sales" data-bind="value: nm_sales">
															</div>
														</div>
														...
														<div class="form-row" data-bind="visible: App.id() === '0'">
															<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																...
																<div class="custom-control custom-radio">
																	<input type="radio" class="custom-control-input" id="opsi_new" name="pengganti" value="1" data-bind="checked: pengganti">
															...
															<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																...
																<div class="custom-control custom-radio">
																	<input type="radio" class="custom-control-input" id="opsi_rotasi" name="pengganti" value="2" data-bind="checked: pengganti">
														...
														<div class="card-body">
															<div class="form-row">
																<div class="col-md-12 col-sm-12 col-xs-12 mb-3">
																	...
																	<input type="text" style="width:100%" class="select2" id="nm_sales_lama" data-bind="value: nm_sales_lama" />
																</div>
															</div>
						...
						$(document).ready(function()
						{
							...
							$('#nm_tap').select2({
								...
								formatResult: function(res){
									return '<div><b>' + res.nama + '</b></div><div style="border-bottom:1px solid #ccc">' + res.nm_cluster + '</div>';
								}
							});
							...
							$('#nm_sales_lama').select2({
								minimumInputLength: 0,
								ajax: {
									url: GLOBAL_MAIN_VARS["BASE_URL"] + 'pilih/get_sales_inrotasi',
									type: 'POST',
									dataType: 'json',
									quietMillis: 200,
									data: function(term){
