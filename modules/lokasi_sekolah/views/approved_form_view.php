					<div class="panel-content">
						<div class="form-row">
							<div class="col-md-12 col-sm-12 col-xs-12 mb-3">
								<label class="form-label" for="no_npsn">NPSN </label>
								<input type="text" class="form-control form-control-sm" id="no_npsn">
							</div>
						</div>
						<input type="hidden" class="form-control form-control-sm" id="id_sekolah" value="<?php echo isset($id_sekolah) ? $id_sekolah : ''; ?>" />
					</div>
