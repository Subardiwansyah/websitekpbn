													...
													<div class="card-body">
														<div class="form-row">
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: npsn">
																...
																<input type="text" class="form-control form-control-sm" id="npsn" data-bind="disable: isEdit, value: npsn">
															</div>
															<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_sekolah">
																...
																<input type="text" class="form-control form-control-sm" id="nm_sekolah" data-bind="value: nm_sekolah">
															</div>
														</div>
														...
														<div class="form-row">
															...
															<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																...
																<select class="form-control form-control-sm" id="jenjang" data-bind="options: list_jenjang, optionsValue:'id', optionsText:'uraian', value: jenjang"></select>
															</div>
															<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																<label class="form-label" for="jml_guru">Jumlah Guru </label>
																<input type="text" class="form-control form-control-sm" id="jml_guru" data-bind="value: jml_guru">
															</div>
															<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																<label class="form-label" for="jml_siswa">Jumlah Siswa </label>
																<input type="text" class="form-control form-control-sm" id="jml_siswa" data-bind="value: jml_siswa">
															</div>
														</div>
													...
													<div class="card-body">
														<div class="form-row">
															...
															<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																...
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_kepsek']) ? format_date($data['tgl_lahir_kepsek']) : '' ?>">
																	<div class="input-group-append">
																		<span class="input-group-text fs-xl">
																			<i class="fal fa-calendar-alt"></i>
																		</span>
