										...
										<form id="frm" method="post" action="<?php echo base_url().$modul; ?>/proses">
											<div class="panel-content">
												...
												<ul class="nav nav-tabs nav-tabs-clean" role="tablist">
													...
													<li class="nav-item">
														<a class="nav-link" data-toggle="tab" href="#tab_merchandising" role="tab">
												...
												<div class="tab-content my-3">
													<div class="tab-pane fade show active" id="tab_profile" role="tabpanel">
														...
														<div class="card mb-3">
															<div class="card-body">
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: npsn">
																		<label class="form-label" for="npsn">NPSN <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="npsn" data-bind="disable: true, value: npsn">
																	</div>
																	<div class="col-md-8 col-sm-8 col-xs-12 mb-3" data-bind="validationElement: nm_sekolah">
																		<label class="form-label" for="nm_sekolah">Nama Sekolah <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="nm_sekolah" data-bind="disable: true, value: nm_sekolah">
																	</div>
																</div>
																...
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3" data-bind="validationElement: id_kel">
																		<label class="form-label" for="nm_kel">Kelurahan <span class="text-danger">*</span> </label>
																...
																<div class="form-row">
																	...
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		...
																		<select class="form-control form-control-sm" id="jenjang" data-bind="disable: true, options: list_jenjang, optionsValue:'id', optionsText:'uraian', value: jenjang"></select>
																	</div>
																	<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																		<label class="form-label" for="jml_guru">Jumlah Guru </label>
																		<input type="text" class="form-control form-control-sm" id="jml_guru" data-bind="disable: true, value: jml_guru">
																	</div>
																	<div class="col-md-2 col-sm-2 col-xs-12 mb-3">
																		<label class="form-label" for="jml_siswa">Jumlah Siswa </label>
																		<input type="text" class="form-control form-control-sm" id="jml_siswa" data-bind="disable: true, value: jml_siswa">
																	</div>
																</div>
														...
														<div class="card mb-3">
															<div class="card-body">
																<div class="form-row">
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: nm_owner">
																		<label class="form-label" for="nm_owner">Nama <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="nm_owner" data-bind="disable: true, value: nm_owner">
																	</div>
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3" data-bind="validationElement: no_hp_owner">
																		<label class="form-label" for="no_hp_owner">No Hp <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="no_hp_owner" data-bind="disable: true, value: no_hp_owner">
																	</div>
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																		<label class="form-label" for="tgl_lahir_owner">Tgl Lahir </label>
																		<div class="input-group input-group-sm">
																			<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_owner" data-bind="disable: true, value: tgl_lahir_owner" value="<?php echo isset($data['tgl_lahir_kepsek']) ? format_date($data['tgl_lahir_kepsek']) : '' ?>">
																			<div class="input-group-append">
																				<span class="input-group-text fs-xl">
																					<i class="fal fa-calendar-alt"></i>
																				</span>
																...
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="hobi_owner">Hobi </label>
																		<input type="text" class="form-control form-control-sm" id="hobi_owner" data-bind="disable: true, value: hobi_owner">
																	</div>
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="akun_fb_owner">Akun Facebook </label>
																		<input type="text" class="form-control form-control-sm" id="akun_fb_owner" data-bind="disable: true, value: akun_fb_owner">
																	</div>
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="akun_ig_owner">Akun Instagram </label>
																		<input type="text" class="form-control form-control-sm" id="akun_ig_owner" data-bind="disable: true, value: akun_ig_owner">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="card">
															<div class="card-body">
																<div class="form-row">
																	<div class="col-md-6 col-sm-6 col-xs-12 mb-3" data-bind="validationElement: nm_pic">
																		<label class="form-label" for="nm_pic">Nama <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="nm_pic" data-bind="disable: true, value: nm_pic">
																	</div>
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3" data-bind="validationElement: no_hp_pic">
																		<label class="form-label" for="no_hp_pic">No Hp <span class="text-danger">*</span> </label>
																		<input type="text" class="form-control form-control-sm" id="no_hp_pic" data-bind="disable: true, value: no_hp_pic">
																	</div>
																	<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
																		<label class="form-label" for="tgl_lahir_pic">Tgl Lahir </label>
																		<div class="input-group input-group-sm">
																			<input type="text" class="form-control form-control-sm datepicker" id="tgl_lahir_pic" data-bind="disable: true, value: tgl_lahir_pic" value="<?php echo isset($data['tgl_lahir_pic']) ? format_date($data['tgl_lahir_pic']) : '' ?>">
																			<div class="input-group-append">
																				<span class="input-group-text fs-xl">
																					<i class="fal fa-calendar-alt"></i>
																				</span>
																...
																<div class="form-row">
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="hobi_pic">Hobi </label>
																		<input type="text" class="form-control form-control-sm" id="hobi_pic" data-bind="disable: true, value: hobi_pic">
																	</div>
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="akun_fb_pic">Akun Facebook </label>
																		<input type="text" class="form-control form-control-sm" id="akun_fb_pic" data-bind="disable: true, value: akun_fb_pic">
																	</div>
																	<div class="col-md-4 col-sm-4 col-xs-12 mb-3">
																		<label class="form-label" for="akun_ig_pic">Akun Instagram </label>
																		<input type="text" class="form-control form-control-sm" id="akun_ig_pic" data-bind="disable: true, value: akun_ig_pic">
																	</div>
																</div>
															</div>
														</div>
					...
					<script>
						...
						var ModelForm = function(){
							...
							self.id = ko.observable("<?php echo isset($data['id_sekolah']) ? $data['id_sekolah'] : 0 ?>");
							self.npsn = ko.observable("<?php echo isset($data['no_npsn']) ? $data['no_npsn'] : '' ?>")
								.extend({
									required: {params: true, message: 'NPSN tidak boleh kosong'}
							});
							self.nm_sekolah = ko.observable("<?php echo isset($data['nama_sekolah']) ? $data['nama_sekolah'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Sekolah tidak boleh kosong'}
							});
							...
							self.alamat = ko.observable("<?php echo isset($data['alamat_sekolah']) ? $data['alamat_sekolah'] : '' ?>")
								.extend({
							...
							self.jenjang = ko.observable("<?php echo isset($data['jenjang']) ? $data['jenjang'] : 'SMA' ?>");
							self.list_jenjang = ko.observableArray([
								new opsi('SD', 'SD'),
								new opsi('SMP', 'SMP'),
								new opsi('SMA', 'SMA'),
								new opsi('PONPES', 'PONPES')
							]);
							self.jml_guru = ko.observable("<?php echo isset($data['jumlah_guru']) ? $data['jumlah_guru'] : 0 ?>");
							self.jml_siswa = ko.observable("<?php echo isset($data['jumlah_siswa']) ? $data['jumlah_siswa'] : 0 ?>");
							...
							self.nm_owner = ko.observable("<?php echo isset($data['nama_kepsek']) ? $data['nama_kepsek'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama Kepsek tidak boleh kosong'}
							});
							self.no_hp_owner = ko.observable("<?php echo isset($data['no_hp_kepsek']) ? $data['no_hp_kepsek'] : '' ?>")
								.extend({
									required: {params: true, message: 'No Hp Kepsek tidak boleh kosong'}
							});
							self.tgl_lahir_owner = ko.observable("<?php echo isset($data['tgl_lahir_kepsek']) ? format_date($data['tgl_lahir_kepsek']) : '' ?>");
							self.hobi_owner = ko.observable("<?php echo isset($data['hobi_kepsek']) ? $data['hobi_kepsek'] : '' ?>");
							self.akun_fb_owner = ko.observable("<?php echo isset($data['akun_fb_kepsek']) ? $data['akun_fb_kepsek'] : '' ?>");
							self.akun_ig_owner = ko.observable("<?php echo isset($data['akun_ig_kepsek']) ? $data['akun_ig_kepsek'] : '' ?>");
							self.nm_pic = ko.observable("<?php echo isset($data['nama_pic']) ? $data['nama_pic'] : '' ?>")
								.extend({
									required: {params: true, message: 'Nama PIC tidak boleh kosong'}
							});
							self.no_hp_pic = ko.observable("<?php echo isset($data['no_hp_pic']) ? $data['no_hp_pic'] : '' ?>")
								.extend({
									required: {params: true, message: 'No Hp PIC tidak boleh kosong'}
							});
							self.tgl_lahir_pic = ko.observable("<?php echo isset($data['tgl_lahir_pic']) ? format_date($data['tgl_lahir_pic']) : '' ?>");
							self.hobi_pic = ko.observable("<?php echo isset($data['hobi_pic']) ? $data['hobi_pic'] : '' ?>");
							self.akun_fb_pic = ko.observable("<?php echo isset($data['akun_fb_pic']) ? $data['akun_fb_pic'] : '' ?>");
							self.akun_ig_pic = ko.observable("<?php echo isset($data['akun_ig_pic']) ? $data['akun_ig_pic'] : '' ?>");
						...
						App.formValidation = function(){
							var errmsg = [];
							var tgl_lahir_1 = $('#tgl_lahir_owner').val();
							var tgl_lahir_2 = $('#tgl_lahir_pic').val();
							var tgl_open = $('#tgl_open').val();
							var tgl_close = $('#tgl_close').val();

							App.tgl_lahir_owner(tgl_lahir_1);
							App.tgl_lahir_pic(tgl_lahir_2);
						...
						/* function lihat_merchandising(tgl, id_sales)
						{
							show_dialog_large(600, 500, 'Merchandising', GLOBAL_MAIN_VARS['BASE_URL'] + GLOBAL_MAIN_VARS["MODUL"] + '/merchandising/' + tgl + '/' + id_sales + '/' + App.id());
						} */
