								...
								<div id="panel-0" class="panel">
									...
									<div class="panel-container show">
										<div class="panel-content">
											...
											<div id="konten_back_checking"></div>

											<!--
											<div id="konten_availability"></div>
											<div id="konten_visibility"></div>
											<div id="konten_advokasi"></div>
											-->
					...
					<script>
						...
						App.tampil = function(){
							...
							$('#konten_back_checking').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/back_checking_form/' +
								id_tap + '/' +
								pilperiode + '/' +
								tahun_kuartal + '/' +
								bulan_kuartal + '/' +
