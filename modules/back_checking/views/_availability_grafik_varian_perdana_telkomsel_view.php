				<div class="card mb-3">
					<div class="card-header bg-primary-100 py-1">
						<div class="card-title" style="font-size:13px;color:#FFFFFF">
							Varian Perdana Telkomsel Share
						</div>
					</div>
					<div class="card-body">

						<div id="container_varian_perdana_telkomsel"></div>
				...
				<script>
					$(document).ready(function(){
						...
						Highcharts.chart('container_varian_perdana_telkomsel', {
							chart: {
								type: 'pie',
								options3d: {
									enabled: true,
							...
							title: {
								text: 'Varian Perdana Telkomsel Share'
							},
							subtitle: {
									text: ' '
							},
