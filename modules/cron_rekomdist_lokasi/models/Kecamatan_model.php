...
class Kecamatan_model extends CI_model {
	...
	function check_trans_status($exception)
  {
	...
	function save_data_kecamatan()
  {
    $this->db->trans_begin();
    try {

			$this->insert_data_kecamatan();
    }
    catch(Exception $e){
	...
	function insert_data_kecamatan()
  {
			...
			(
					SELECT
							...
							, (
										...
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
							...
							, (
										...
										FROM
												fe_daftar_pjp xd
												INNER JOIN eb_outlet xl
														ON (xd.id_tempat = xl.id_outlet)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
							...
							, (
										...
										FROM
												fe_daftar_pjp xd
												INNER JOIN ec_sekolah xl
														ON (xd.id_tempat = xl.id_sekolah)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xd.tanggal, "%Y") = "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												fe_daftar_pjp xd
												INNER JOIN ed_kampus xl
														ON (xd.id_tempat = xl.id_universitas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xd.tanggal, "%Y") = "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												fb_histroy_pjp xh
												INNER JOIN ed_kampus xl
														ON (xh.id_tempat = xl.id_universitas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xh.tanggal, "%Y") = "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												fe_daftar_pjp xd
												INNER JOIN ee_fakultas xl
														ON (xd.id_tempat = xl.id_fakultas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xd.tanggal, "%Y") = "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												fb_histroy_pjp xh
												INNER JOIN ee_fakultas xl
														ON (xh.id_tempat = xl.id_fakultas)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xh.tanggal, "%Y") = "'.$tahun_sekarang.'"
							...
							, (
										...
										FROM
												fe_daftar_pjp xd
												INNER JOIN ef_poi xl
														ON (xd.id_tempat = xl.id_poi)
												INNER JOIN cd_kelurahan xkl
														ON (xl.id_kelurahan = xkl.id_kelurahan)
										WHERE (xkl.id_kecamatan = kc.id_kecamatan
												AND DATE_FORMAT(xd.tanggal, "%Y") = "'.$tahun_sekarang.'"
		...
		if (!empty($rs))
		{
			...
			{
				$this->db->select('1');
				$this->db->from('ai_dashboard_coverage_kecamatan');
				$this->db->where('tahun', $tahun_sekarang);
				$this->db->where('bulan', (int) $bulan_sekarang);
				$this->db->where('id_kecamatan', $rs[$x]['id_kecamatan']);
				...
				if ($rsx)
				{
					$data_x = array(
						...
						'id_kecamatan' => $rs[$x]['id_kecamatan'],
					...
					$this->db->where('bulan', (int) $bulan_sekarang);
					$this->db->where('id_kecamatan', $rs[$x]['id_kecamatan']);
					$this->db->update('ai_dashboard_coverage_kecamatan', $data_x);
					$this->check_trans_status('update ai_dashboard_coverage_kecamatan failed');
				}
				else
				{
					$data_x = array(
					...
					$this->db->insert('ai_dashboard_coverage_kecamatan', $data_x);
					$this->check_trans_status('insert ai_dashboard_coverage_kecamatan failed');
				}
			}
		}
	}
