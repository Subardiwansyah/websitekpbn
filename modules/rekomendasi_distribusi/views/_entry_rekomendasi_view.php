					...
					<form id="frmtabentry" method="post" action="<?php echo base_url(); ?>rekomendasi_distribusi/proses_entry_rekomendasi">
							...
							<table id="dt_table_3" class="table table-bordered m-0 table-sm table-striped">
								<thead class="bg-primary-100">
									...
									<tr>
										...
										<td rowspan="2"><div align="center"><strong>VOUCHER<br>INTERNET</strong></div></td>
										<td colspan="3"><div align="center"><strong>VOUCHER GAME</strong></div></td>
						...
						<?php if (in_array($hari_ini, array('Wednesday', 'Thursday', 'Friday'))) { ?> <!-- HARI RABU, KAMIS & JUMAT-->
