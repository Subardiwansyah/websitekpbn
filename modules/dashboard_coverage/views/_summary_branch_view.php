				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table id="dt_table_1" class="table table-bordered m-0 table-sm table-striped" style="font-size:12px">
								<thead>
									<tr style="font-size:11px;">
										<td class="bg-primary-270" rowspan="3" style="width:40px;"><div align="center" style="margin-top:25px;"><strong>NO</strong></div></td>
										<td class="bg-primary-270" rowspan="3" style="width:170px;"><div align="center" style="margin-top:25px;"><strong>BRANCH</strong></div></td>
