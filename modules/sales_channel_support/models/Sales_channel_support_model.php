...
class Sales_channel_support_model extends Base_Model {
	...
	function build_query_daftar_1()
	{
		...
		if ($id_level == 1) // Regional
		{
			...
			$this->db->where('UPPER(s.id_jenis_sales)', 'SCS');
