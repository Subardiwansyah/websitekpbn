...
class Sales_channel_support extends Base_Controller {

	function __construct()
	{
		parent::__construct($securePage=true);

		$this->modul_name = 'sales_channel_support';
		$this->daftar_display = 'List Channel Suport';
		$this->form_display = 'Form Channel Suport';
		$this->modul_display = 'Channel Suport';
		$this->view_list = 'sales_channel_support_list_view';
		$this->view_form = 'sales_channel_support_form_view';
		$this->view_view = 'sales_channel_support_view_view';
		$this->load->model('Sales_channel_support_model', 'data_model');
	}
