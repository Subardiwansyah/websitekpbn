					<table id="dt_table_1" class="table table-bordered m-0 table-sm table-striped">
						<thead class="bg-primary-100">
							<tr style="font-size:11px;">
								<td class="bg-primary-100" rowspan="4">TANGGAL</td>
								<td class="bg-primary-100" rowspan="4">HARI</td>
							...
							<tr style="font-size:11px;">
								...
								<td rowspan="3">NEW RS PER HARI</td>
								<td rowspan="3">LIMIT LINK AJA</td>
								<td>PERDANA<br>SHARE</td>
								<td>VOUCHER FISIK<br>SHARE</td>
								<td>LAYAR TOKO<br>SHARE</td>
								<td>POSTER SHARE</td>
