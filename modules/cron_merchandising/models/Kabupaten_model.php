				...
				for ($b=0; $b<count($arr_share); $b++)
				{
					...
					$this->db->from('
						(
							...
							WHERE (xkc.id_kabupaten = "'.$id_kabupaten.'"
					...
					$this->db->select('1');
					$this->db->from('mk_merchandising_res_kabupaten');
					...
					if ($rs_d)
					{
						...
						$this->db->where('id_jenis_lokasi', $id_jenis_lokasi);
						$this->db->where('id_jenis_share', $id_jenis_share);
						$this->db->update('mk_merchandising_res_kabupaten', $data_x);
						$this->check_trans_status('update mk_merchandising_res_kabupaten failed');
					}
					else
					{
						$data_x = array(
						...
						$this->db->insert('mk_merchandising_res_kabupaten', $data_x);
						$this->check_trans_status('insert mk_merchandising_res_kabupaten failed');
					}
				}
			}
		}
