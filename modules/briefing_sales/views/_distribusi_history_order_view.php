				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table id="dt_table_3" class="table table-bordered table-sm table-striped" border="1">
								<thead>
									<tr>
										<td rowspan="4" style="background-color:#8080ff; color:#FFFFFF; width:200px;">DATA</td>
										<td style="background-color:#8080ff; color:#FFFFFF;" colspan="16">W</td>
										<td style="background-color:#8080ff; color:#FFFFFF;" colspan="16">W-1</td>
										<td style="background-color:#8080ff; color:#FFFFFF;" colspan="16">W-2</td>
										<td style="background-color:#8080ff; color:#FFFFFF;" colspan="16">W-3</td>
									</tr>
									<tr style="font-size:9px;">
										<td class="bg-primary-230" colspan="6">SEGEL</td>
										<td class="bg-primary-230" colspan="3">SA</td>
										<td class="bg-primary-230" colspan="3">VOUCHER INTERNET</td>
										<td class="bg-primary-230" colspan="3">VOUCHER GAME</td>
										<td class="bg-primary-230" rowspan="3">LA</td>
									...
									<tr style="font-size:9px;">
										<td class="bg-primary-230" colspan="2">PERDANA</td>
										<td class="bg-primary-230" rowspan="2">VOUCHER INTERNET</td>
										<td class="bg-primary-230" colspan="3">VOUCHER GAME</td>
										<td class="bg-primary-230" rowspan="2">LD</td>
										<td class="bg-primary-230" rowspan="2">MD</td>
										<td class="bg-primary-230" rowspan="2">HD</td>
										<td class="bg-primary-230" rowspan="2">LD</td>
										<td class="bg-primary-230" rowspan="2">MD</td>
										<td class="bg-primary-230" rowspan="2">HD</td>
										<td class="bg-primary-230" rowspan="2">LD</td>
									...
									<tr style="font-size:9px;">
										<td class="bg-primary-230">PREPAID</td>
										<td class="bg-primary-230">USIM</td>
										<td class="bg-primary-230">SILVER</td>
										<td class="bg-primary-230">GOLD</td>
										<td class="bg-primary-230">PLATINUM</td>
