...
class Report_penjualan_model extends Base_Model {
	 ...
	 *  Module	: -
	 */
	var $fieldmap_daftar = array('no_nota', 'tgl_transaksi', 'pembayaran', 'total_perdana', 'total_linkaja');
	var $column_order = array(null, 'no_nota', 'tgl_transaksi', 'pembayaran', 'total_perdana', 'total_linkaja');
	var $column_search = array('no_nota', 'tgl_transaksi', 'pembayaran', 'total_perdana', 'total_linkaja');
		...
		$this->db->from('
			(
				SELECT
						...
						, COALESCE(SUM(p.link_aja), 0) AS total_linkaja
				FROM
	...
	/**
	 *  Fungsi	: Menampilkan data perjualan by nota
	 *  Module	: -
	 */
	...
	/**
	 *  Fungsi	: Menampilkan daftar penjualan
	 *  Module	: -
	 */
