								...
								<div id="panel-0" class="panel">
									...
									<div class="panel-container show">
										<div class="panel-content">
											...
											<div id="konten_vos"></div>
											<div id="konten_vos_survey"></div>
					...
					<script>
						...
						App.tampil = function(){
							...
							$('#konten_vos').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/voice_of_reseller_form/' +
								id_tap + '/' +
								pilperiode + '/' +
								tahun_kuartal + '/' +
								bulan_kuartal + '/' +
							...
							$('#konten_vos_survey').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/voice_of_reseller_survey_form/' +
								id_tap + '/' +
								pilperiode + '/' +
								tahun_kuartal + '/' +
								bulan_kuartal + '/' +
