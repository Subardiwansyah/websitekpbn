											<ul class="nav nav-tabs nav-tabs-clean" role="tablist">
												<li class="nav-item">
													<a class="nav-link fs-xs active" data-toggle="tab" href="#tab_perdana" onClick="reload_tab('perdana')">
														<i class="fal fa-credit-card-front mr-1 text-success"></i>
														PERDANA SHARE
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link fs-xs" data-toggle="tab" href="#tab_voucher_fisik" onClick="reload_tab('voucher_fisik')">
														<i class="fal fa-credit-card-blank mr-1 text-warning"></i>
														VOUCHER FISIK SHARE
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link fs-xs" data-toggle="tab" href="#tab_spanduk" onClick="reload_tab('spanduk')">
												...
												<li class="nav-item">
													<a class="nav-link fs-xs" data-toggle="tab" href="#tab_papan_nama" onClick="reload_tab('papan_nama')">
														<i class="fal fa-id-card mr-1 text-secondary"></i>
														NEON BOX SHARE
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link fs-xs" data-toggle="tab" href="#tab_backdrop" onClick="reload_tab('backdrop')">
														<i class="fal fa-qrcode mr-1 text-success"></i>
														STIKER SCAN QR SHARE
													</a>
												</li>
											</ul>
											<div class="tab-content my-3">
												<div class="tab-pane fade show active" id="tab_perdana" role="tabpanel">
													<!-- BEGIN PERDANA SHARE -->

													<div id="konten_tbl_regional_perdana" class="konten_tbl_regional"></div>
													<div id="konten_tbl_branch_perdana" class="konten_tbl_branch"></div>
													<div id="konten_tbl_cluster_perdana" class="konten_tbl_cluster"></div>
													<div id="konten_tbl_kabupaten_perdana" class="konten_tbl_kabupaten"></div>
													<div id="konten_tbl_kecamatan_perdana" class="konten_tbl_kecamatan"></div>
													<div id="konten_tbl_tap_perdana" class="konten_tbl_tap"></div>
													<div id="konten_tbl_sales_perdana" class="konten_tbl_sales"></div>

													<!-- END PERDANA SHARE -->
												</div>
												<div class="tab-pane fade" id="tab_voucher_fisik" role="tabpanel">
												...
												<div class="tab-pane fade" id="tab_spanduk" role="tabpanel">
													<!-- BEGIN SPANDUK SHARE -->
												...
												<div class="tab-pane fade" id="tab_papan_nama" role="tabpanel">
													<!-- BEGIN NEON BOX SHARE -->

													<div id="konten_tbl_regional_papan_nama" class="konten_tbl_regional"></div>
													<div id="konten_tbl_branch_papan_nama" class="konten_tbl_branch"></div>
													<div id="konten_tbl_cluster_papan_nama" class="konten_tbl_cluster"></div>
													<div id="konten_tbl_kabupaten_papan_nama" class="konten_tbl_kabupaten"></div>
													<div id="konten_tbl_kecamatan_papan_nama" class="konten_tbl_kecamatan"></div>
													<div id="konten_tbl_tap_papan_nama" class="konten_tbl_tap"></div>
													<div id="konten_tbl_sales_papan_nama" class="konten_tbl_sales"></div>

													<!-- BEGIN NEON BOX SHARE -->
												</div>
												<div class="tab-pane fade" id="tab_backdrop" role="tabpanel">
													<!-- BEGIN BACKDROP SHARE -->

													<div id="konten_tbl_regional_backdrop" class="konten_tbl_regional"></div>
													<div id="konten_tbl_branch_backdrop" class="konten_tbl_branch"></div>
													<div id="konten_tbl_cluster_backdrop" class="konten_tbl_cluster"></div>
													<div id="konten_tbl_kabupaten_backdrop" class="konten_tbl_kabupaten"></div>
													<div id="konten_tbl_kecamatan_backdrop" class="konten_tbl_kecamatan"></div>
													<div id="konten_tbl_tap_backdrop" class="konten_tbl_tap"></div>
													<div id="konten_tbl_sales_backdrop" class="konten_tbl_sales"></div>
											...
											<input type="hidden" class="" id="x_jenis_share" value="perdana">
