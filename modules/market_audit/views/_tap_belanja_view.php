				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table id="dt_table_13" class="table table-bordered m-0 table-sm table-striped" style="width:100%">
								<thead>
									<tr>
				...
				<script>
					$(document).ready(function(){
						$('#dt_table_13').removeAttr('width').DataTable({
							// responsive: true,
							// scroller: true,
							"bDestroy": true,
							pageLength: 25,
							...
							serverSide: true,
							ajax: {
								url: GLOBAL_MAIN_VARS['BASE_URL'] + GLOBAL_MAIN_VARS['MODUL'] + '/get_daftar_13',
								type: 'POST',
								data: {
