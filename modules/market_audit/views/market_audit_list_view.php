								...
								<div id="panel-2" class="panel">
									...
									<div class="panel-container show">
										<div class="panel-content">
													...
													<div class="form-row">
														<div class="col-md-3 col-sm-3 col-xs-12 mb-3">
															...
															<select class="select2" id="kategori" data-bind="value: kategori">
																...
																<?php } ?>
																<?php if ($id_level == 1 || $id_level == 2 || $id_level == 3 || $id_level == 4) { ?>
											...
											<div id="konten_market_audit"></div>
					...
					<script>
						...
						$(document).ready(function()
						{
							...
							$('#pilihan').select2({
								...
								ajax: {
									url: GLOBAL_MAIN_VARS["BASE_URL"] + 'pilih/get_bct_inmarketaudit',
									type: 'POST',
									dataType: 'json',
									quietMillis: 200,
									data: function(term){
						...
						var ModelForm = function(){
							...
							self.jenis_share = ko.observable("belanja");
						...
						App.tampil = function(){
							...
							var jenis_share = App.jenis_share();
							...
							$('#konten_market_audit').load(
								GLOBAL_MAIN_VARS["BASE_URL"] + GLOBAL_MAIN_VARS["MODUL"] + '/market_audit_form/' +
								kategori + '/' +
								pilihan + '/' +
								tahun + '/' +
								bulan + '/' +
